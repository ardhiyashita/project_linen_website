...
<!-- Page Heading -->
<form action="{{ route('satuan.edit.save', $content->id) }}" method="POST">
@csrf
<h1 class="h3 mb-2 text-gray-800">Edit Master Data Satuan</h1>
<div class="row">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" placeholder="Eg. Kilogram, Hektogram" value="{{ $content->satuan }}" class="form-control ps-0 form-control-line" name="satuan"
                            id="satuan">
                    </div>
                    @error('satuan')
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" placeholder="Eg. kg, hg"
                            class="form-control ps-0 form-control-line" value="{{ $content->singkatan }}" name="singkatan"
                            id="singkatan">
                    </div>
                    @error('singkatan')
                        <div class="alert alert-danger" role="alert">
