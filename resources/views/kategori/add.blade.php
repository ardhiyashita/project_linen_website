...
<!-- Page Heading -->
<form action="{{ route('kategori.add.save') }}" method="POST" enctype="multipart/form-data">
@csrf
<h1 class="h3 mb-2 text-gray-800">Tambah Master Data Kategori Produk</h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Eg. Baju, Celana" value=""
                                    class="form-control ps-0 form-control-line" name="category_name"
